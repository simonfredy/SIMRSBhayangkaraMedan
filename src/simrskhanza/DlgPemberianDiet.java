...
public class DlgPemberianDiet extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NmBentukDiet = new widget.TextBox();
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-08-2023" }));
        ...
        jLabel13.setText("Bentuk Makanan :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(750, 40, 90, 23);

        NmBentukDiet.setEditable(false);
        NmBentukDiet.setHighlighter(null);
        NmBentukDiet.setName("NmBentukDiet"); // NOI18N
        FormInput.add(NmBentukDiet);
        NmBentukDiet.setBounds(850, 40, 140, 23);
        ...
        BtnSeek3.setBounds(990, 40, 28, 23);
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    */
    ...
    private widget.TextBox NmBentukDiet;
