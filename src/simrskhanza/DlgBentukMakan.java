 ...
 * @author dosen
 */
public class DlgBentukMakan extends javax.swing.JDialog {
    ...
    /** Creates new form DlgBentukMakan
     * @param parent
     * @param modal */
    public DlgBentukMakan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ps=koneksi.prepareStatement("select kd_bentuk_makan, bentuk_makan_diet "+
                " from bentuk_makan where kd_bentuk_makan like ? or "+
                " bentuk_makan_diet ? order by kd_bentuk_makan");
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Bentuk Makan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel3.setText("Kode Bentuk Makan :");
        jLabel3.setName("jLabel3"); // NOI18N
        panelGlass7.add(jLabel3);
        jLabel3.setBounds(2, 12, 110, 23);

        jLabel4.setText("Bentuk Makan :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass7.add(jLabel4);
        jLabel4.setBounds(230, 10, 90, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            Valid.textKosong(TKd,"kode bentuk makan");
        }else if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"bentuk makan");
        }else{
            if(Sequel.menyimpantf("bentukmakan","'"+TKd.getText()+"','"+TNm.getText()+"'","Kode bentuk makan")==true){
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbSpesialis.getSelectedRow()!= -1){
            if(Sequel.meghapustf("bentukmakan","kd_bentuk_makan",tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(),0).toString())==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(tbSpesialis.getSelectedRow()>-1){
                if(Sequel.mengedittf("bentukmakan","kd_bentuk_makan=?","kd_bentuk_makan=?,bentuk_makan_diet=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBentukMakan dialog = new DlgBentukMakan(new javax.swing.JFrame(), true);
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer("bentukmakan","BM",2,TKd);
        TKd.requestFocus();
    }
